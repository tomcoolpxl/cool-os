...
C_SRCS := src/kernel.c src/serial.c src/gdt.c src/idt.c src/isr.c src/pmm.c src/heap.c src/pic.c src/pit.c src/timer.c src/task.c src/scheduler.c src/syscall.c src/paging.c
